<div class='flex flex-col justify-center overflow-hidden bg-gray-50 w-full'>
    <div class="flex justify-end bg-white p-3">
        <div class="flex items-center space-x-5">
            <button wire:click="showModal(true)">
                <svg class="h-6 w-6" viewBox="0 -0.5 21 21" version="1.1" xmlns="http://www.w3.org/2000/svg"
